...
const ProductDetails = (props) => {
    const [product, setProduct] = useState({}); //surute ekta empty object hisebe thakbe
    const [error, setError] = useState(false);
    const [success, setSuccess] = useState(false);

    useEffect(() => {
        const id = props.match.params.id; //react router e match namer property er moddhe sob ghula jay.
